...
Интеграция с системным треем и меню пауза/проверка/интервал/выход.

Смена интервала из трея (10/15/20/30/45/60 мин), применяется сразу и сохраняется в `config.ini`.
...
- **Интервал**: Выбрать предустановленный интервал (10/15/20/30/45/60 мин). Новое значение применяется сразу и сохраняется в `config.ini`.
